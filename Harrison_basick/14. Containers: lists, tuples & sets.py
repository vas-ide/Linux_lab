...
names_list = ['Alexandr', 'Romeo', 'Sergio', 'Mihail']
print(names_list)
names_list_sort = sorted(names_list)
...
print(people)
leo_data = ('Leonid', 'V-----n', 4)
ksy_data = ('KSY', 'V-----n', 35)
people.append(leo_data)
people.append(ksy_data)
sorted(people)
print(people)
people.sort()
print(people)
#3.________________________________________________________________
friends_names = ['Alex', 'Ksy', 'Andrey', 'Viktor', 'Sergio', 'Leonid', 'Vitaliy', 'Romeo' ]
frequent_names = ['Andrey', 'Konstantin', 'Olga', 'Any', 'Katy', 'Vitaliy', 'Sergio', 'Igor', 'Oleg', 'Alex']
friends_names_set = set(friends_names)
frequent_names_set = set(frequent_names)
friends_frequent_set = frequent_names_set & friends_names_set
print(friends_frequent_set)
